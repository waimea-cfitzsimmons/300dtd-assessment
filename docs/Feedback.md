...
> You docs have a few holes, Cam... get them sorted ASAP as you need to be moving on from this
...
> Ok, but a lot needs fixing:
> - End-users - see the exemplar. Should be a profile of a typical users, inc. their specific needs
> - Solution / functionality - Needs to be a detailed list of the features the system should have - don't assume the reader knows what you're talking about!
> - Implications - Ok, but usability should reference Neillsen, plus I would have expected Aesthetics being important for this application.
> - UX - Ok, but any other aspects that are important for this project?
