...
$router->route(GET, PAGE, '/campaign/$id', 'pages/campaigns.php');
$router->route(GET, PAGE, '/characters', 'pages/characters.php');
$router->route(GET, PAGE, '/character/$id', 'pages/characters.php');   
...
$router->route(POST, HTMX, '/assign-character', 'actions/assign-character.php');
